<div class="tab-pane fade" id="v-pills-contact" role="tabpanel" aria-labelledby="v-pills-contact-tab">
    <fieldset class="border p-3">
        ...
        <div class="row">
            ...
            <div class="mb-4 col-md-6">
                <label for="contact_form_subtitle" class="form-label">Contact Form Title</label>
                <input type="text" class="form-control" id="contact_form_subtitle" name="contact_form_subtitle"
                    placeholder="Contact Form Title" value="{{ $settings['contact_form_subtitle'] }}" />
