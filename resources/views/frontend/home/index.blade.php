                ...
                <div class="col-sm-9">
                    <div class="planning-success__content mb-xs-35 wow fadeInUp" data-wow-delay=".3s">
                        <h2 class="title mb-20 mb-sm-15 mb-xs-10 color-white">Good Business Planning Ensures Success.</h2>
                            ...
                            <a href="" class="theme-btn btn-sm btn-red">View All Services <i class="far fa-chevron-double-right"></i></a>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        <div class="why-choose__content why-choose__content-home mt-md-25 mt-sm-20 mt-xs-20 wow fadeInUp" data-wow-delay=".5s">
                            ...
                            <a href="services-2.html" class="theme-btn btn-sm btn-red mt-30 mt-sm-25 mt-xs-20">{{$settings['services_button']}} <i class="far fa-chevron-double-right"></i></a>
                        </div>
                    </div>
                </div>
    @php
